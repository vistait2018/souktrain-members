...
var datepickr = (function() {
	...
	function buildMonths(config, currentMonthView, currentYearView) {
		...
		prevYear = buildNode('span', { className: 'prev-year' }, buildNode('span', { className: 'prevYear' }, '|&lt;&lt;')),
		...
		nextYear = buildNode('span', { className: 'next-year' }, buildNode('span', { className: 'nextYear' }, '&gt;&gt;|'));
		
		months.appendChild(prevYear);
