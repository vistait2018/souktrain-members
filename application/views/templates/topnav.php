...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <ul class="nav navbar-right top-nav">
            <li >
                <a href="https://store.souktrain.com" target="blank" class="dropdown-toggle" data-toggle="dropdown">Store</a><i class="fa fa-shopping-cart"></i> Online store <b class="caret"></b></a>
