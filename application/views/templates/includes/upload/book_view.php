                    ...
                    <div class="panel-body">
                        ...
                        <div class=" table-responsive ">
                            <table class="table table-bordered table-hover ">
                                ...
                                if (isset($book)) {
                                    echo'<tr><th></th>';
                                    echo'<td><img src="'.base_url().$book->cover.' " class="img-responsive square" ></td>
                                   </tr>';
                            ...
                            <a href="<?php echo base_url('index.php/upload/downloader/').$book->id.'/'.$book->title ?>" target="_blank"> <button class="btn btn-default pull-right "><i class="fa fa-download fa-fw"></i>Download</button></a>';
