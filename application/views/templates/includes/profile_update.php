        ...
        <div class="row">
            <div class="col-lg-10">
                <h1 class="page-header">
                    Souktrain |<small> Update your Profile Information-This information cannot be <b>Changed.</b><i>It gives access to buy products from our accredited stores.</i></small>
                </h1>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        ...
                        if (!isset($_SESSION['user_id']))  {
                            ...
                            // var_dump($profile);
                            echo'<div class=" alert alert-success center">Profile Update| registration .</div>';
                        }
                        ?>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>Address</td>
                                <td>
                                     <textarea rows="2" cols="50"class="form-control" name="address" value="<?php echo set_value('address')?>"  autocomplete="off" placeholder="Your Address" ></textarea> <br>
                ...
                <tr>
                       ...
                       <input  type="file" name="picture_url"  onchange="document.getElementById('blah').src = window.URL.createObjectURL(this.files[0])">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="maiden" value="<?php echo set_value('maiden' ); ?>"  >
                                </td>
                            </tr>
                           <tr>
                                <td>Secret Word</td>
                                <td><input type="text" class="form-control" name="secret" value="<?php echo set_value('secret' ); ?>"  >
                                </td>
                            </tr>
                            </tbody>
                        </table>
