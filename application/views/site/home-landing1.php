...
<!-- Mirrored from agmstudio.io/themes/material-style/2.0.3/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jan 2018 07:26:26 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href=" <?php print('assets/landing/assets/css/preload.min.css') ;?>">
    <link rel="stylesheet" href=" <?php print('assets/landing/assets/css/plugins.min.css') ;?>">
    <link rel="stylesheet" href=" <?php print('assets/landing/assets/css/style.light-blue-500.min.css') ;?>">
    <link rel="stylesheet" href="<?php print('assets/landing/assets/css/width-boxed.min.css" id="ms-boxed" disabled="">');?>">
    <!--[if lt IE 9]>

    <script src="<?php print('assets/landing/assets/js/html5shiv.min.js')?>" ></script>
    <script src="<?php print('assets/landing/assets/js/respond.min.js')?> "></script>
    <![endif]-->
</head>
<body>
...
<script src="<?php print('assets/landing/assets/js/plugins.min.js');?>"></script>
<script src="<?php print('assets/landing/assets/js/app.min.js');?>"></script>
<script src="<?php print('assets/landing/assets/js/configurator.min.js');?>"></script>
<script>
...
<!-- Mirrored from agmstudio.io/themes/material-style/2.0.3/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jan 2018 07:28:45 GMT -->
</html>