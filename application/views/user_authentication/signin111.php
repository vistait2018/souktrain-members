                ...
                <div class="col-md-offset-4 col-md-4 col-sm-offset-2 col-sm-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p class="change_link">
                                <i class="fa fa-lock"> <a href="<?php echo base_url()?>user_authentication/passwordresets" >forgot Password! </a></i>

                                <i class="fa fa-check pull-right"> &nbsp;<a href="<?php echo base_url()?>user_authentication/register">Sign Up </a></i>
                            </p>
