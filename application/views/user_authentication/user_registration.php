...
<head>
    ...
    <title>ST-Register</title>
</head>
 <?php if( !isset($_POST['agree']) or empty( $_POST['agree']))
                         $message = '<div class="/alert alert-danger"/><br>Please agree with the policy.<br><br></div>';
                        ?>
<body  style="background-image: url('<?php print base_url('assets/pexels-photo-175328.jpeg') ?>');
       background-size: cover; background-repeat: no-repeat ">
<?php  $referral_id =$this->session->flashdata('referral_id');
        ...
        <div class="col-sm-offset-3 col-sm-6 col-xs-offset-2 col-sm-8">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" size="13" class="form-control" name="phone_no" value="<?php echo set_value('phone_no')?>"  autocomplete="off" placeholder="08067874533" >
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
	                        <?php echo form_submit(array('id' => 'btnSubmit', 'value' => 'Register' ,'class' =>'btn btn-primary btn-send') ); ?>&nbsp;
                        </div>
                        <div class="col-md-4">
                ...
                <div class="panel-footer">
                    <div class="footer"> <p class="pull-right">Powered By <a href="#">DiamondWeb &copy<?php echo date('Y');?></p></div>
                </div>
            </div>
        </div>
    </div>
