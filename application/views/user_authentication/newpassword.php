...
<div class="panel-body">
                ...
                <?php
				echo form_open('User_authentication/newPassword/'.@$tokens);?>
              ...
              <div>
                     ...
                     <button name="reg" class="btn btn-default " type="submit">Change Password</button>&nbsp;
                     <button name="reset" class="btn btn-default " type="reset">Reset</button><br>
               ...
               <!-- <a class="reset_pass" href="#">Lost your password?</a>-->
                  ...
                  <p class="change_link">
                          <i class="fa fa-lock"> <a href="signin" >Sign In  </a></i>
