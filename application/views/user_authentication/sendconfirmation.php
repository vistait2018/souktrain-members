...
<div class="panel-body">
                ...
                <?php  echo form_open('user_authentication/sendmail');?>
                                
                          <?php  if (isset($message) and $message != NULL) echo '<div class="alert alert-info">'.$message.'</div>'; ?>
              ...
              <div>
                 <button  class="btn btn-default " type="submit">Send</button>&nbsp;<button name="reg" class="btn btn-default " type="reset">Reset</button><br>
               ...
               <!-- <a class="reset_pass" href="#">Lost your password?</a>-->
                  ...
                  <p class="change_link">
                          <i class="fa fa-unlock"> <a href="oauth" >Login </a></i>
