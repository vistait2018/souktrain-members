...
<div class="panel-body">
                ...
                <?php  echo form_open();?>
                  ...
                  <div>
                     ...
                     Email  <input type="text" class="form-control" name="email" autocomplete="off">
                   </div><br>
              <div>
                       <?php echo '<div class="text text-danger">'. form_error('password').'</div>'; ?>
                     Password   <input type="password" class="form-control" name="password"   autocomplete="off" /><br>
                    </div>
              <div>

                     <button name="reg" class="btn btn-default " type="submit">Sign in</button>
                     <button name="reg" class="btn btn-default " type="reset">Reset</button><br>
               ...
               <!-- <a class="reset_pass" href="#">Lost your password?</a>-->
                  ...
                  <p class="change_link">
                      <i class="fa fa-lock"> <a href="<?php echo base_url()?>User_authetication/sendconfirmation" >forgot Password! </a></i>

                          <i class="fa fa-check pull-right"> &nbsp;<a href="<?php echo base_url()?>User_authetication/register">Sign Up </a></i>
                  </p>
